...
function zot_info_extra($customizer) {
    ...
    $customizer->add_section('zot_customizer_colors', array(
        'title'     => __( 'Cores', THEMENAME),
        'priority'  => 0,
        'panel'     => 'zot_customizer_panel'
    ));

    $customizer->add_section('zot_customizer_footer', array(
    ...
    // $customizer->add_setting('colors_theme',
    //     array(
    //         'default' => '#000'
    //     )
    // );

    // $customizer->add_control('control_colors_theme',
    //     array(
    //         'label' 	=> 'Cor do Tema (Mobile "theme-color"):',
    //         'type'		=> 'color',
    //         'section'	=> 'zot_customizer_colors',
    //         'settings'	=> 'colors_theme'
    //     )
    // );
    

    $customizer->add_setting('colors_primary',
        array(
            'default' => '#000'
        )
    );

    $customizer->add_control('control_colors_primary',
        array(
            'label' 	=> 'Cor Primária',
            'type'		=> 'color',
            'section'	=> 'zot_customizer_colors',
    ...
    $customizer->add_setting('footer_bg', array(
        'default' => ''
    ));

    $customizer->add_control( new WP_Customize_Image_Control($customizer, 'control_footer_bg', array(
        'label'    => 'Background Footer',
        'section'  => 'zot_customizer_footer',
        'settings' => 'footer_bg',
    )));


    // $customizer->add_setting('colors_secundary',
    //     array(
    //         'default' => '#000'
    //     )
    // );

    // $customizer->add_control('control_colors_secundary',
    //     array(
    //         'label' 	=> 'Cor Secundária:',
    //         'type'		=> 'color',
    //         'section'	=> 'zot_customizer_colors',
    //         'settings'	=> 'colors_secundary'
    //     )
    // );
